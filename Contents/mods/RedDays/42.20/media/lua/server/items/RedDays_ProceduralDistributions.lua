...
-- Sandbox vars are not available at load time, so we register unconditionally.
-- The handler checks SandboxVars.RedDays.hygiene_items_spawn_on_corpses internally.
